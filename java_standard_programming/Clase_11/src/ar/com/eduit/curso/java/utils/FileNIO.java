...
public class FileNIO implements I_File{
    ...
    public void setText(String text) {
        ...
        try {
            BufferedWriter out = Files.newBufferedWriter(archivo, charset, StandardOpenOption.TRUNCATE_EXISTING);
            out.write(text);
            out.close();
        } catch (Exception e) {
            Log.setC(e);
    ...
    public void appendText(String text) {
        Path archivo = Paths.get(file);
        try {
            BufferedWriter out = Files.newBufferedWriter(archivo, charset, StandardOpenOption.APPEND);
            out.write(text);
            out.close();
        } catch (Exception e) {
            Log.setC(e);
