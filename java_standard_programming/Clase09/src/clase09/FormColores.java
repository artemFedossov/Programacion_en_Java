...
public class FormColores extends javax.swing.JFrame {
    ...
    public void cargar(){
        ...
        fileU.getTreeSetLines().forEach(item->{
            txaTexto.append(item+"\n");
    ...
    private void initComponents() {
        ...
        cmbColores.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if(!color.equals("")) fileU.appendLine(color);
        txtColor.setText("");
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        // EventoBorrar
        fileU.removeLine(txtColor.getText());
        txtColor.setText("");
        txtColor.requestFocus();
        cargar();
